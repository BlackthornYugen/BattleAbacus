...
app.run(["CharacterManager", "Spell", "Hazard", "Feat", "Character", function (CharacterManager, Spell, Hazard, Feat, Character) {
    "use strict";
    CharacterManager.setActiveCharacter(); // Set default character
